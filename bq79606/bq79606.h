...
int  WriteReg(BYTE bID, uint16_t wAddr, uint64 dwData, BYTE bLen, BYTE bWriteType);
int  ReadReg(BYTE bID, uint16_t wAddr, BYTE * pData, BYTE bLen, uint32_t_t dwTimeOut, BYTE bWriteType);
